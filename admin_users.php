...
<section class="users">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <h4 class="boxTitle"> User <?php echo $fetch_users['userID']; ?></h4>
         <p> Username : <span><?php echo $fetch_users['name']; ?></span> </p>
         <p> Email : <span><?php echo $fetch_users['email']; ?></span> </p>
         <p> User Type : <span style="color:<?php if($fetch_users['type'] == 'admin'){ echo 'var(--orange)'; } ?>"><?php echo $fetch_users['type']; ?></span> </p>
